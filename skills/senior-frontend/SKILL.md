...
When senior-frontend is invoked by Ralph Loop (parse-ralph-loop skill) for specialist review, it MUST provide a resumption signal at the end of its response.

**Detection**: If invoked as part of Parse Ralph Loop Phase 4 (CRITICAL REVIEW) for FRONTEND_UX issues.
...
**RALPH_LOOP_RESUME**: senior-frontend review complete.

**Issue Category**: FRONTEND_UX
